    ...
    <main>
      {userleavecount &&
        userleavecount.map((leavecount, index) => (
          <section key={index} className="p-5 dark:text-white bg-slate-200 dark:bg-slate-600 mb-8">
            <div className="w-full flex p-2">
              <h2 className="text-xl font-bold text-[#374151] dark:text-white">User Leave Balance</h2>
            </div>
              ...
              <div className="md:border-r  w-full">
                <span className="flex justify-center gap-4 h-[10rem] text-center items-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div className="p-2 border rounded-md">
                    ...
                    <div className="text-4xl text-black">{leavecount?.floaterleave}
              ...
              <div className="md:border-r  w-full">
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div className="p-2 border rounded-md">
                    ...
                    <div className="text-4xl text-black">{leavecount?.privilageleave}
                ...
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div className="p-2 px-8 border rounded-md">
                    <p className="flex items-center justify-center text-black opacity-70 text-xl">Sick Leaves</p>
                       ...
                       <div className="text-4xl text-black">{leavecount?.sickleave}</div>
              ...
              <div className="md:border-r w-full">
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div className="p-2 px-3 border rounded-md">
                    ...
                    <p className="text-4xl text-black">{leavecount?.casualleave}</p>
                    <div className="border rounded-md text-xl bg-slate-100">Total 5</div>
                  </div>
                </span>
              </div>
              ...
              <div className=" w-full">
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div className="p-2 px-4 border rounded-md">
                    ...
                    <p className="text-4xl text-black">{leavecount?.unpaidleave}</p>
            ...
            <div className="w-full flex p-2">
              <h2 className="text-xl font-bold text-[#374151] dark:text-white">User Leave Activity</h2>
            </div>
            ...
            <section className="available_leave_section grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 w-full  p-5">
              <div className=" ">
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-4xl text-black">{leavecount?.totalLeaves}</p>
                  </div>
                </span>
              </div>
              ...
              <div className="">
                <span className="flex justify-center gap-4 h-[10rem] text-center items-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div>
                    ...
                    <p className="text-4xl text-black">{leavecount?.pendingLeaves}</p>
                  </div>
                </span>
              </div>
              ...
              <div className="">
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div>
                    ...
                    <p className="text-4xl text-black">{leavecount?.approvedLeaves}</p>
                  </div>
                </span>
              </div>
              ...
              <div className="">
                <span className="flex justify-center gap-4 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div>
                    ...
                    <p className="text-4xl text-black">{leavecount?.rejectedLeaves}</p>
                  </div>
                </span>
              </div>
              ...
              <div className="">
                <span className="flex justify-center gap-2 h-[10rem] items-center text-center bg-white dark:bg-slate-300 rounded-lg text-black">
                  ...
                  <div>
                    ...
                    <p className="text-4xl text-black">{leavecount?.cancelledLeaves}</p>
                  </div>
                </span>
              </div>
              ...
              <div className="">
                <span className="flex justify-center gap-2 h-[10rem] items-center text-center bg-white dark:bg-slate-300">
                  <span className="rounded-full p-3 bg-[#BDB76B] text-black"><FaRegCalendarTimes size={35} /></span>
                  <div className="p-4">
                    <p className="flex items-center justify-center text-black opacity-70 text-xl">Expired Leaves</p>
                    <p className="text-4xl text-black">{leavecount?.expiredLeaves}</p>
                  </div>
                </span>
              </div>
            </section>
