...
const ManageTickets = () => {
  ...
  const dataSource = data?.map((ticket) => {
  ...
  return (
    <div className='w-full h-full p-4'>
      ...
      {
        isPending ? (<div>Loading....</div>) : (<Table columns={columns} dataSource={dataSource} />)
      }
      <Modal
        centered
        open={isModalOpen}
        ...
        footer={null}
      >
        <EditTicket record={record} isOpen={isModalOpen} setIsOpen={setIsModalOpen} />
      </Modal>
    </div>
  )
}
