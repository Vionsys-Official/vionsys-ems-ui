    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="bg-white p-6 shadow-lg rounded-lg w-full max-w-lg">
        ...
        >
          ...
          >
            <Select placeholder="Select Ticket Type" className="w-full rounded-lg">
          ...
          >
            <TextArea rows={4} placeholder="Describe the issue" className="rounded-lg" />
          </Form.Item>
          ...
          <div className="flex justify-between items-center">
            <Form.Item>
              <Button
                type="primary"
                className="bg-[#7498D0] hover:bg-slate-600 px-6 py-2 rounded-lg text-white"
                htmlType="submit"
              >
